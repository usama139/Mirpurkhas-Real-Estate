                ...
                <div>
                    <Swiper navigation>
                        {listing.imageUrls && listing.imageUrls.map(url => (
                            <SwiperSlide key={url}>
                                <div className='h-[400px]' style={{ background: `url(${url}) center no-repeat`, backgroundSize: 'cover' }}></div>
                            </SwiperSlide>
                        ))}
                    </Swiper>
                        ...
                        <div className='flex gap-4'>
                            ...
                            {listing.offer && (
                                <p className='bg-green-900 w-full max-w-[200px] text-white text-center p-1 rounded-md'>
                                    Rs{(+listing.regularPrice - +listing.discountPrice).toLocaleString('en-PK')}
                                </p>
                            )}
                        </div>
